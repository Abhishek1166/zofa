    ...
    function $_taskAdd( getParent ) {
        ...
        $('[data-btnfn="addTask"]').off('click').on('click', function(event) {
            ...
            if (getAddBtnClass === 'task-simple') {
                ...
                $html =   '<div data-draggable="true" class="card simple-title-task">'+
                                '<div class="card-body">'+
                ...
                var $_taskProgress = $('.range-count-number').attr('data-rangeCountNumber');
                    ...
                    $html = '<div data-draggable="true" class="card task-text-progress">'+
                                '<div class="card-body">'+
                ...
                $html =   '<div data-draggable="true" class="card img-task ui-sortable-handle">'+
                                '<div class="card-body">'+
